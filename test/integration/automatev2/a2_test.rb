# # Inspec test for support-a2::default
...
# describe file '/home/vagrant/automate-credentials.toml' do
#   it { should exist }
#   it { should be_file }
...
# # elasticsearch
# describe file '/home/vagrant/elasticsearch_config.toml' do
#     it { should exist }
#     it { should be_file }
#   #  its('content') { should match(/heapsize = "2048"/) }
# end
